...
func (s *VisitorService) CreateVisitor(v *domain.Visitor, userID string, role string) error {
...
func (s *VisitorService) UpdateVisitorStatus(email, status string, userID string, role string) error {

    return s.Repo.UpdateVisitorStatus(email, status)
}
